...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        joy0.button(11).whileTrue(new InstantCommand(() -> positionHandler.setPose(2)));
        ...
        joy0.button(12).whileTrue(new InstantCommand(() -> positionHandler.setPose(5)));
    }
}